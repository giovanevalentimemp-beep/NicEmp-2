...
export function ToolCard({
  ...
  return (
    <a
      href={href}
      className={`relative bg-white rounded-3xl border p-7 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl flex flex-col justify-between min-h-[190px] ${comingSoon ? "opacity-60 pointer-events-none" : ""}`}
    >
      {popular && (
